...
class ReservationController extends Controller
{
    ...
    public function store(ReservationStoreRequest $request)
    {
      ...
      foreach($table->reservations as $res)
            if($res->res_date->format('Y-m-d') == $request_date->format('Y-m-d')){
                return back()->with('warning','This table is reserved for this day , thank you!');
            }
    ...
    public function update(ReservationStoreRequest $request,Reservation $reservation)
    {
        ...
        if($request->guest_number > $table->guest_number){
            ...
            return back()->with('warning','Please choose the table not more than table guest number ,thank you!');
        }
        ...
        foreach($reservations as $res){
            if($res->res_date->format('Y-m-d') == $request_date->format('Y-m-d')){
                return back()->with('warning','Please choose order is this day');
            }
        }
