...
<body class="font-sans antialiased">
    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white bg-slate-100 md:w-64 dark-mode:text-gray-200 dark-mode:bg-gray-800" x-data="{ open: false }">
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
        ...
        <main class="w-full p-8 m-2">
            ...
            <div>
                ...
                <div class="flex p-4 mb-4 text-sm text-yellow-700 bg-red-100 rounded-lg dark:bg-yellow-200 dark:text-yellow-800" role="alert">
                    <div>
