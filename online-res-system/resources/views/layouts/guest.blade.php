    ...
    <div class="bg-white shadow-md" x-data="{ isOpen: false }">
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
            <div class="flex items-center justify-between">
                <a class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-800 md:text-5xl hover:text-green-800"
                    href="#">
                    Kwee Phyo And Nyi ,Nyi Ma Nge Mya...
                </a>
                <!-- Mobile menu button -->
            ...
            <div :class="isOpen ? 'flex' : 'hidden'"
                ...
                <a class="text-3xl text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400"
                    href="/">Home</a>
